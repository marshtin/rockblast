...
def puntos_camion(query_aux):
    ...
    try:
        ...
        df_puntos_camion = pd.read_sql_query(query_camion, conn)
        
        # Preparación de datos para el gráfico
        x = df_puntos_camion['longitude'].tolist()
        y = df_puntos_camion['latitude'].tolist()
        #z = df['elevation'].tolist()
        s = df_puntos_camion['speed'].tolist()
